...
$(function(){
    ...
    if (typeof $.fn.plupload !== "function" && typeof plupoad_ui_plugin_loaded == "undefined") {
        $.getCachedScript( ui_plugin_root + 'engine/classes/uploads/html5/plupload/plupload.ui.min.js?v=2');
    }
