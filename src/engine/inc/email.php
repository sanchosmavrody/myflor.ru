  ...
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="reg_mail_text">{$mail_template['reg_mail']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="feed_mail_text">{$mail_template['feed_mail']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="lost_mail_text">{$mail_template['lost_mail']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse4" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="new_news_text">{$mail_template['new_news']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse5" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="new_comments_text">{$mail_template['comments']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse6" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="new_pm_text">{$mail_template['pm']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse7" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="wait_mail_text">{$mail_template['wait_mail']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse8" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="twofactor_text">{$mail_template['twofactor']}</textarea>
  ...
  <div class="accordion-group">
    ...
    <div id="collapse9" class="accordion-body collapse">
      <div class="accordion-inner mt-20">
		...
		<textarea dir="auto" class="classic" rows="15" style="width:100%;" name="new_newsletter_text">{$mail_template['newsletter']}</textarea>
      </div>
    </div>
  </div>  
