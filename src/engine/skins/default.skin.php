...
$html_classes = array('htmlfontsize-50', 'htmlfontsize-75', 'htmlfontsize-90', 'htmlfontsize-110', 'htmlfontsize-120', 'htmlfontsize-130', 'htmlfontsize-140', 'htmlfontsize-150', 'htmlfontsize-175', 'htmlfontsize-200');
...
if ($html_class) {
	$html_class = " class=\"".htmlspecialchars ( trim($html_class), ENT_QUOTES, $config['charset'] )."\"";
}
...
$skin_footer = <<<HTML
    ...
    <div id="style_switcher" title="{$lang['settings_panel_1']}" style="display: none;">
        ...
        <div>
			...
			<div class="col-sm-6 no-padding-left">
				<span class="position-left">{$lang['settings_panel_13']}</span><select class="uniform" name="html_font_size" id="html_font_size" data-width="auto" data-size="7"><option value="htmlfontsize-50">50%</option><option value="htmlfontsize-75">75%</option><option value="htmlfontsize-90">90%</option><option value="">100%</option><option value="htmlfontsize-110">110%</option><option value="htmlfontsize-120">120%</option><option value="htmlfontsize-130">130%</option><option value="htmlfontsize-140">140%</option><option value="htmlfontsize-150">150%</option><option value="htmlfontsize-175">175%</option><option value="htmlfontsize-200">200%</option></select>
			</div>
        </div>
